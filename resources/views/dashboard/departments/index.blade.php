                                            ...
                                            <table id="example1" class="table table-stripped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center">{{ trans('main.Employees Count') }}</th>
                                                        <th class="text-center">{{ trans('main.Employees Total Salary') }}</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{ $item->users()->sum('salary')}}</td>
